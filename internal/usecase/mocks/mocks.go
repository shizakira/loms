...
func (_mock *OrderStorage) GetByID(ctx context.Context, orderID int64) (domain.Order, error) {
	...
	var r0 domain.Order
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int64) (domain.Order, error)); ok {
		return returnFunc(ctx, orderID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int64) domain.Order); ok {
...
func (_c *OrderStorage_GetByID_Call) Run(run func(ctx context.Context, orderID int64)) *OrderStorage_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OrderStorage_GetByID_Call) RunAndReturn(run func(ctx context.Context, orderID int64) (domain.Order, error)) *OrderStorage_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
